macro(add_imhex_plugin)
    ...
    if (IMHEX_PLUGIN_IMPORTED)
        ...
        if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/tests/CMakeLists.txt AND IMHEX_ENABLE_UNIT_TESTS AND IMHEX_ENABLE_PLUGIN_TESTS AND NOT IMHEX_STATIC_LINK_PLUGINS)
            ...
            add_dependencies(plugins_test ${IMHEX_PLUGIN_NAME})
