        ...
        ContentRegistry::Language::addLocalizations("zh-CN", {
                ...
                { "hex.builtin.setting.interface", "界面" },
                    ...
                    { "hex.builtin.setting.interface.wiki_explain_language", "维基百科语种" },
                        { "hex.builtin.setting.interface.wiki_explain_language.interface", "使用界面语言" },
                        { "hex.builtin.setting.interface.wiki_explain_language.english", "英语" },
                        { "hex.builtin.setting.interface.wiki_explain_language.custom", "自定义" },
