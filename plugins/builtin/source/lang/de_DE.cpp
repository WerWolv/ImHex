        ...
        ContentRegistry::Language::addLocalizations("de-DE", {
            ...
            /* Builtin plugin features */
                ...
                { "hex.builtin.tools.wiki_explain", "Wikipedia Definition" },
                    { "hex.builtin.tools.file_uploader.control", "Einstellungen" },
                    { "hex.builtin.tools.file_uploader.search", "Suchen" },
                    { "hex.builtin.tools.file_uploader.results", "Resultate" },
                    { "hex.builtin.tools.file_uploader.invalid_response", "Ungültige Antwort von Wikipedia!" },
