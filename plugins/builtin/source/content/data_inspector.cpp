...
namespace hex::plugin::builtin {
    ...
    void registerDataInspectorEntries() {
        ...
        ContentRegistry::DataInspector::add("hex.builtin.inspector.time32", sizeof(i32), [](auto buffer, auto endian, auto style) {
            ...
            std::string value;
            auto optval = wolv::util::formatTTPOSIX(lc.c_str(), endianAdjustedTime,  wolv::util::TTSz::_32);
            if (!optval) {
                value = "Invalid";
            }
            else {
            ...
            std::string ws;
            auto optws = wolv::util::formatTT(lc.c_str(), endianAdjustedTime, wolv::util::TTSz::_32);
            if (!optws) {
                ws = "Invalid";
            }
            else {
        ...
        ContentRegistry::DataInspector::add("hex.builtin.inspector.time64", sizeof(i64), [](auto buffer, auto endian, auto style) {
            ...
            std::string value;
            auto optval = wolv::util::formatTTPOSIX(lc.c_str(), endianAdjustedTime, wolv::util::TTSz::_64);
            if (!optval) {
                value = "Invalid";
            }
            else {
            ...
            std::string ws;
            auto optws = wolv::util::formatTT(lc.c_str(), endianAdjustedTime, wolv::util::TTSz::_64);
            if (!optws) {
                ws = "Invalid";
            }
            else {
