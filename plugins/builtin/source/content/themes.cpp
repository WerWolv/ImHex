        ...
        RequestInitThemeHandlers::subscribe([] {
...

            {
                const static ThemeManager::ColorMap TextEditorColorMap = {
                    ...
                    { "doc-global-comment",         u32(TextEditor::PaletteIndex::DocGlobalComment)        },
                    ...
                    { "local-variable",             u32(TextEditor::PaletteIndex::PatternLocalVariable)    },
                    { "pattern-placed-variable",    u32(TextEditor::PaletteIndex::PatternPlacedVariable)   },
