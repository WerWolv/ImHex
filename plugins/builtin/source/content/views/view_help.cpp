...
namespace hex::plugin::builtin {
    ...
    void ViewHelp::drawAboutPopup() {
        if (ImGui::BeginPopupModal(View::toWindowName("hex.builtin.view.help.about.name").c_str(), &this->m_aboutWindowOpen, ImGuiWindowFlags_AlwaysAutoResize)) {
            ...
            ImGui::TextUnformatted("hex.builtin.view.help.about.libs"_lang);
            ImGui::Separator();
            ImGui::PushStyleColor(ImGuiCol_ChildBg, ImVec4(0.2F, 0.2F, 0.2F, 0.3F));
            ...
            ImGui::NewLine();
            ImGui::TextUnformatted("hex.builtin.view.help.about.paths"_lang);
            ImGui::Separator();
    ...
    void ViewHelp::drawPatternHelpPopup() {
        ...
        if (ImGui::Begin(View::toWindowName("hex.builtin.view.help.pattern_cheat_sheet").c_str(), &this->m_patternHelpWindowOpen)) {
    ...
    void ViewHelp::drawMathEvaluatorHelp() {
        ...
        ImGui::SetNextWindowSizeConstraints(ImVec2(450, 300), ImVec2(2000, 1000));
        if (ImGui::Begin(View::toWindowName("hex.builtin.view.help.calc_cheat_sheet").c_str(), &this->m_mathHelpWindowOpen)) {
    ...
    void ViewHelp::drawMenu() {
        if (ImGui::BeginMenu("hex.menu.help"_lang)) {
            ...
            ImGui::Separator();
            if (ImGui::MenuItem("hex.builtin.view.help.pattern_cheat_sheet"_lang, "")) {
                this->m_patternHelpWindowOpen = true;
                this->getWindowOpenState() = true;
            }
            if (ImGui::MenuItem("hex.builtin.view.help.calc_cheat_sheet"_lang, "")) {
