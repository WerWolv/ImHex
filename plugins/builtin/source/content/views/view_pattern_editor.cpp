        ...
        if (ImGui::BeginTable("##sections_table", 3, ImGuiTableFlags_SizingStretchProp | ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg | ImGuiTableFlags_ScrollY, size)) {
            ...
            if (TRY_LOCK(ContentRegistry::PatternLanguage::getRuntimeLock())) {
                for (auto &[id, section] : sections) {
                    ...
                    ImGui::SetTooltip("%s", (const char*)"hex.builtin.view.pattern_editor.sections.view"_lang);
                    ImGui::SameLine();
                    ...
                    ImGui::SetTooltip("%s", (const char*)"hex.builtin.view.pattern_editor.sections.export"_lang);
