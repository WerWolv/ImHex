...
namespace hex::ui {
    ...
    void PatternDrawer::createDefaultEntry(const pl::ptrn::Pattern &pattern) {
        ...
        // Draw type column
        ImGui::TableNextColumn();
        ImGuiExt::TextFormattedColored(TextEditor::GetPalette()[u32(TextEditor::PaletteIndex::PlacedVariable)], "{}", pattern.getFormattedName().empty() ? pattern.getTypeName() : pattern.getFormattedName());
    }
    ...
    void PatternDrawer::visit(pl::ptrn::PatternBitfieldField& pattern) {
        ...
        if (dynamic_cast<pl::ptrn::PatternBitfieldFieldSigned*>(&pattern) != nullptr) {
            ...
            ImGui::SameLine();
            ImGuiExt::TextFormattedColored(TextEditor::GetPalette()[u32(TextEditor::PaletteIndex::PlacedVariable)], pattern.getBitSize() == 1 ? "bit" : "bits");
            ...
            ImGuiExt::TextFormattedColored(TextEditor::GetPalette()[u32(TextEditor::PaletteIndex::PlacedVariable)], "bool");
            ImGui::SameLine();
            ImGuiExt::TextFormattedColored(TextEditor::GetPalette()[u32(TextEditor::PaletteIndex::PlacedVariable)], "bit");
        } else {
    ...
    void PatternDrawer::drawArray(pl::ptrn::Pattern& pattern, pl::ptrn::IIterable &iterable, bool isInlined) {
        ...
        if (!isInlined && m_treeStyle != TreeStyle::Flattened) {
            ...
            ImGui::TableNextColumn();
            ImGuiExt::TextFormattedColored(TextEditor::GetPalette()[u32(TextEditor::PaletteIndex::PlacedVariable)], "{0}", pattern.getTypeName());
            ImGui::SameLine(0, 0);
