...
typedef struct ImGuiStyleShadowTexConfig ImGuiStyleShadowTexConfig;
...
typedef struct ImVector_unsigned_int {int Size;int Capacity;unsigned int* Data;} ImVector_unsigned_int;

struct ImDrawChannel
{
    ImVector_ImDrawCmd _CmdBuffer;
    ImVector_unsigned_int _IdxBuffer;
};
...
struct ImDrawList
{
    ...
    ImVector_unsigned_int IdxBuffer;
...
typedef struct ImFontAtlasShadowTexConfig ImFontAtlasShadowTexConfig;
...
typedef ImVector<unsigned int> ImVector_unsigned_int;
#endif //CIMGUI_DEFINE_ENUMS_AND_STRUCTS
