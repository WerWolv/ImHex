...
namespace hex::pl {
    ...
    public:
        ...
        using Literal    = std::variant<char, bool, u128, i128, double, std::string, std::shared_ptr<PatternData>>;
        ...
        static u128 literalToUnsigned(const pl::Token::Literal &literal) {
            return std::visit(overloaded {
                                  ...
                                  [](const std::shared_ptr<PatternData> &) -> u128 { LogConsole::abortEvaluation("expected integral type, got custom type"); },
        ...
        static i128 literalToSigned(const pl::Token::Literal &literal) {
            return std::visit(overloaded {
                                  ...
                                  [](const std::shared_ptr<PatternData> &) -> i128 { LogConsole::abortEvaluation("expected integral type, got custom type"); },
        ...
        static double literalToFloatingPoint(const pl::Token::Literal &literal) {
            return std::visit(overloaded {
                                  ...
                                  [](const std::shared_ptr<PatternData> &) -> double { LogConsole::abortEvaluation("expected integral type, got custom type"); },
        ...
        static bool literalToBoolean(const pl::Token::Literal &literal) {
            return std::visit(overloaded {
                                  ...
                                  [](const std::unique_ptr<PatternData> &) -> bool { LogConsole::abortEvaluation("expected integral type, got custom type"); },
        ...
        static std::string literalToString(const pl::Token::Literal &literal, bool cast) {
            ...
            return std::visit(overloaded {
                                  ...
                                  [](const std::shared_ptr<PatternData> &) -> std::string { LogConsole::abortEvaluation("expected integral type, got custom type"); },
